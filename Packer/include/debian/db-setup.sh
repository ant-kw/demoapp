...
sudo DEBIAN_FRONTEND=noninteractive apt-get install -qq vim htop atop make ruby apt-transport-https ca-certificates curl daemonize apt-utils lsb-release cron at logrotate rsyslog lsof procps python3-pip wget curl postgresql-15 postgres-client
